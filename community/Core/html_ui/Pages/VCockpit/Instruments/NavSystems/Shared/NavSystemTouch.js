class NavSystemTouch extends NavSystem {
    ...
    makeButton(_button, _callback) {
        ...
        _button.addEventListener("mouseup", this.onButtonPressed.bind(this, _button));
        _button.onButtonPressedCallback = _callback
    }
    onButtonPressed(_button) {
        // console.log(this.instrumentIdentifier)
        // console.log(_button.id)
        YourControlOnPanelEvent(this.instrumentIdentifier, _button.id)
        _button.onButtonPressedCallback();
                ...
                if (this.departureWaypoints.length <= i) {
                    ...
                    this.departureWaypoints[i].base = document.createElement("tr");
                    {
                        let td1 = document.createElement("td");
                        {
                            ...
                            this.departureWaypoints[i].identButton.id = "DepartureWaypoint_" + i;
                            {
                        ...
                        let td2 = document.createElement("td");
                        {
                            ...
                            this.departureWaypoints[i].altButton.id = "DepartureWaypoint_Altitude_" + i;
                            {
            ...
            if (this.enRouteWaypoints.length <= i) {
                ...
                this.enRouteWaypoints[i].base = document.createElement("tr");
                {
                    let td1 = document.createElement("td");
                    {
                        ...
                        this.enRouteWaypoints[i].identButton.id = "EnrouteWaypoint_" + i;
                        {
                    ...
                    let td2 = document.createElement("td");
                    {
                        ...
                        this.enRouteWaypoints[i].altButton.id = "EnrouteWaypoint_Altitude_" + i;
                        {
                ...
                if (this.arrivalWaypoints.length <= i) {
                    ...
                    this.arrivalWaypoints[i].base = document.createElement("tr");
                    {
                        let td1 = document.createElement("td");
                        {
                            ...
                            this.arrivalWaypoints[i].identButton.id = "ArrivalWaypoint_" + i;
                            {
                        ...
                        let td2 = document.createElement("td");
                        {
                            ...
                            this.arrivalWaypoints[i].altButton.id = "ArrivalWaypoint_Altitude_" + i;
                            {
                    ...
                    if (i >= this.approachWaypoints.length) {
                        ...
                        this.approachWaypoints[i].base = document.createElement("tr");
                        {
                            let td1 = document.createElement("td");
                            {
                                ...
                                this.approachWaypoints[i].identButton.id = "ApproachWaypoint_" + i;
                                {
                            ...
                            let td2 = document.createElement("td");
                            {
                                ...
                                this.approachWaypoints[i].altButton.id = "ApproachWaypoint_Altitude_" + i;
                                {
